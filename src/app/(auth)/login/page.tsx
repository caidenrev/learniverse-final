...
const GoogleIcon = () => (
  <svg className="h-5 w-5" viewBox="0 0 48 48">
    ...
    <path
      fill="#4CAF50"
      d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.222,0-9.519-3.108-11.187-7.231l-6.571,4.819C9.656,39.663,16.318,44,24,44z"
    ></path>
    <path
      fill="#1976D2"
